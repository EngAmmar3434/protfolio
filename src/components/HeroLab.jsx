        ...
        >
          {isLeft ? (
            <>
              ...
              <h2 className="heading mt-1.5 text-[clamp(1.12rem,4.2vw,3.2rem)] font-black leading-[0.9] sm:mt-2 lg:mt-4">
                {activeModule.title}
              </h2>
              <p className="lab-body mt-1.5 max-w-md text-[0.72rem] leading-4 sm:mt-2 sm:text-sm sm:leading-5 lg:mt-4 lg:text-sm xl:text-base">
            ...
            <>
              ...
              <p className="mt-1.5 text-sm font-black text-white sm:mt-2 lg:mt-3 lg:text-base">{activeModule.railTitle}</p>
              <p className="mt-1.5 text-[0.72rem] leading-4 text-white/58 sm:mt-2 sm:text-sm sm:leading-5 lg:mt-3 lg:leading-6">{activeModule.proof}</p>
              <div className="mt-auto grid grid-cols-2 gap-2 pt-2 lg:gap-3 lg:pt-5">
  ...
  return (
    <div className="relative grid min-h-[198px] place-items-center sm:min-h-[270px] md:min-h-[310px] lg:min-h-[410px] xl:min-h-[440px]">
      <AnimatePresence mode="wait" custom={direction}>
        ...
        >
          <div
            className="absolute bottom-[-16%] left-1/2 h-16 w-[78%] -translate-x-1/2 rounded-full blur-2xl lg:h-24 xl:h-28"
            style={{
              background:
          ...
          <motion.div
            ...
            style={{
              ...
              filter: "drop-shadow(0 0 24px rgba(156,236,255,0.62))",
            }}
          >
            <Icon
              aria-hidden="true"
              ...
              style={{
                filter: `drop-shadow(0 0 16px rgba(156,236,255,0.92)) drop-shadow(0 0 36px ${activeModule.energy})`,
              }}
            />
