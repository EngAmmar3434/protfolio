  ...
  return (
    <section id="contact" className="lab-section pb-10">
      <div className="lab-container">
        <div className="hud-frame relative overflow-hidden p-5 sm:p-6 md:p-10 lg:p-14">
          ...
          <div className="relative grid gap-7 sm:gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:items-end">
            <div>
              <p className="lab-kicker text-[var(--lab-gold)]">{sectionContent.contact.eyebrow}</p>
              <h2 className="heading mt-4 max-w-4xl text-[clamp(2.25rem,11vw,4.2rem)] font-black leading-[0.9] text-white sm:mt-6 md:text-[clamp(3.3rem,8vw,7.2rem)] md:leading-[0.84]">
                {profile.fullName}
              </h2>
              <p className="lab-body mt-5 max-w-2xl sm:mt-7">{profile.intro}</p>
            </div>
          ...
          <div className="relative mt-8 flex flex-col justify-between gap-3 border-t border-white/10 pt-5 text-sm text-white/42 sm:mt-12 md:flex-row">
